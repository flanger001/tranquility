...
class Admin::StaffControllerTest < ActionController::TestCase
  ...
  test "should create staff" do
    assert_difference('Staff.count') do
      post :create, staff: { credentials: @staff.credentials, name: @staff.name, title: @staff.title }
    end
  ...
  test "should update staff" do
    patch :update, id: @staff, staff: { credentials: @staff.credentials, name: @staff.name, title: @staff.title }
    assert_redirected_to staff_path(assigns(:staff))
  end
